<!DOCTYPE html>
<html >
<body background="Images/Website-Design-Background.png" marginheight="1200" marginwidth="756" >
  <head>
    <meta charset="UTF-8">
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=1684368868518492";
...
<a href='javascript:sendTokenToServer()'>Login with Facebook</a>
      ...
      <div class="logmod__tab lgm-2">
        <div class="logmod__heading">
          <span class="logmod__heading-subtitle">Welcome to <strong><b>Bazaar</b></strong></span>
        </div> 
        <div class="logmod__form">
          <form accept-charset="utf-8" action="#" class="simform">
            <div class="sminputs">
