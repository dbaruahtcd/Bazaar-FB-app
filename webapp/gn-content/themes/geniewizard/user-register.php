<?php
    ...
    geniewizards_add_body_class('register');
...
<div class="row">
  <div class="col-md-4 col-md-offset-4">
    ...
    <div class="title">
      <h1>
        <?php _e('Register an account for free', genieWIZARDS_THEME_FOLDER); ?>
      </h1>
    </div>
      <form name="register" action="<?php echo osc_base_url(true); ?>" method="post" enctype="multipart/form-data" >
        ...
        <div class="form-group">
          <label class="control-label" for="name">
            <?php _e('Name', genieWIZARDS_THEME_FOLDER); ?> <sup>*</sup>
          </label>
          <div class="controls">
        ...
        <div class="form-group">
          <label class="control-label" for="password-2">
            <?php _e('Repeat password', genieWIZARDS_THEME_FOLDER); ?> <sup>*</sup>
          </label>
          <div class="controls">
            <?php UserForm::check_password_text(); ?>
            <p id="password-error" style="display:none;">
              <?php _e("Passwords don't match", genieWIZARDS_THEME_FOLDER); ?>
            </p>
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="controls">
            ...
            <?php _e("Create An Account", genieWIZARDS_THEME_FOLDER); ?>
            </button>
          </div>
        </div>
      </form>
